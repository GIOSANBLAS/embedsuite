...
class TehLinkResponseParserTest {
    ...
    fun parseDeviceInfo_readsHardwareAndFirmware() {
        val data = JSONObject(
            """
            {
              ...
              "firmware": "Bruce-0.20.1",
              "product": "T-Embed Bruce",
              "version": "Bruce-0.20.1",
              "codename": "Bruce",
              "channel": "release",
              "proto": "teh-link",
              "proto_ver": 3
        ...
        assertEquals("Bruce-0.20.1", info.firmware)
    }
    ...
    // ========== BRUCE v0.17 HARDENING + OTA SHA256 + SOAK ==========
    ...
    fun parseDeviceStatus_readsHeapCoredumpAndWdtReason() {
        ...
        assertEquals(123456L, status.heapFreeBytes)
        assertEquals(8388608L, status.psramFreeBytes)
    ...
    fun parseActionState_containsOtaAndSoakFields() {
        ...
        assertEquals(4096L, s.leakBytes)
    ...
    fun parseSoakResult_healthyWhenLeakUnderThreshold() {
        ...
        assertEquals(244L, soak.leakBytes)
    }
