...
object AppInfo {
    ...
    val tagline = "Professional platform for Bruce TEH-Link companion control"
    ...
    val changelog = listOf(
        ChangelogEntry(
            ...
            date = "Ago 2026",
            highlights = listOf(
                "Catálogo oficial Bruce (pr3y/Bruce) con descarga desde GitHub",
        ...
        ChangelogEntry(
            ...
            date = "Ago 2026",
            highlights = listOf(
                "Firmware Bruce v0.20.0: list_files / download_file, batería y sd_status en get_info",
        ...
        ChangelogEntry(
            ...
            highlights = listOf(
                ...
                "Firmware catalog: Bruce oficial (pr3y/Bruce) + custom local"
            )
        )
    )
...
• USB: comunicación directa con el T-Embed CC1101 Plus vía OTG (TEH-Link / protocolo Bruce).
...
8. CONTACTO
Desarrollador: GIOSÁNBLAS — proyecto EMBED SUITE (companion T-Embed CC1101 Plus / firmware Bruce · TEH-Link).
