...
class UsbSerialManager(private val context: android.content.Context) {
    ...
    companion object {
        ...
        fun createProber(): UsbSerialProber {
            ...
            table.addProduct(Esp32UsbIds.VENDOR_ESPRESSIF, Esp32UsbIds.PID_BRUCE_CDC, com.hoho.android.usbserial.driver.CdcAcmSerialDriver::class.java)
    ...
    /** Pide permiso USB al T-Embed si aún no lo tiene. */
    ...
    /**
     * Bruce CLI: líneas texto terminadas en `\n` (115200 8N1).
     */
