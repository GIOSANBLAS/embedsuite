...
enum class ScriptDialect { TEHLINK_JSON, TEHLINK_JS, BADUSB_FINTEK, MACRO_SEQUENCE, BRUCE_CLI }
...
data class Script(
    ...
    /** Línea CLI Bruce (Serial Wiki) cuando [dialect] es [ScriptDialect.BRUCE_CLI]. */
