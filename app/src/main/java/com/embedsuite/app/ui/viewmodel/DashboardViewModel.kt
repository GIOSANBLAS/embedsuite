...
class DashboardViewModel(
    ...
    /** Bruce: borra coredump pendiente tras reset anormal (TWDT / BOD). */
    fun clearCoredump() {
        viewModelScope.launch {
    ...
    /** Bruce: ejecuta soak/stress test desde la app (equivalente al test_suite PowerShell). */
    ...
    fun openBrucePlugin(pluginId: String) {
        viewModelScope.launch {
