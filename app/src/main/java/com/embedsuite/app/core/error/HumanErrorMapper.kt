...
object HumanErrorMapper {
    ...
    fun mapMessage(message: String?): String {
        ...
        return when {
            ...
            lower.contains("teh-link solo disponible") || lower.contains("solo disponible con t-embed bruce") ->
                "El perfil no es Bruce (o se perdió tras reconectar). Pulsa Conectar, espera LINK verde y reintenta."
